package ashish.springframework.spring5recipeapp.bootstrap;

import ashish.springframework.spring5recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public List<Recipe> getRecipes(){
        ...
        if(!eachUomOptional.isPresent())
            throw new RuntimeException("Each Uom is Required");

        Optional<UnitOfMeasure> tableSpoonOptional = unitOfMeasureRepository.findByDescription("Tablespoon");
        if(!tableSpoonOptional.isPresent())
            throw new RuntimeException("TableSpoon Uom is Required");

        Optional<UnitOfMeasure> teaSpoonOptional = unitOfMeasureRepository.findByDescription("Teaspoon");
        if(!teaSpoonOptional.isPresent())
            throw new RuntimeException("TeaSpoon Uom is Required");

        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("Dash");
        if(!dashUomOptional.isPresent())
            throw new RuntimeException("dash Uom is Required");

        Optional<UnitOfMeasure> pintUomOptional = unitOfMeasureRepository.findByDescription("Pint");
        if(!pintUomOptional.isPresent())
            throw new RuntimeException("pint Uom is Required");

        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.findByDescription("Cup");
        if(!cupsUomOptional.isPresent())
            throw new RuntimeException("Cup Uom is Required");
